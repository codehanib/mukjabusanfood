...
<style>
    ...
    /* 하단 버튼 스타일 */
    .btn-group-bottom { display: flex; justify-content: center; gap: 15px; margin-top: 30px; margin-bottom: 10px; flex-wrap: wrap; }
    .btn-main { display: inline-block; padding: 12px 24px; background-color: #FF5722; color: #ffffff; text-decoration: none; border-radius: 6px; font-weight: bold; font-size: 1em; transition: background 0.2s; }
    .btn-main:hover { background-color: #e64a19; }
    .btn-history { display: inline-block; padding: 12px 24px; background-color: #333333; color: #ffffff; text-decoration: none; border-radius: 6px; font-weight: bold; font-size: 1em; transition: background 0.2s; }
    .btn-history:hover { background-color: #555555; }
</style>
...
<div class="container">
    ...
    <div class="status-bar">
        <div class="step ${delivery.d_stats == '주문확인' || delivery.d_stats == '주문접수' ? 'active' : ''}">1. 접수대기</div>
    ...
    <!-- 4. 하단 이동 버튼 영역 (메인 화면 / 내 주문 내역) -->
    <div class="btn-group-bottom">
        <a href="${pageContext.request.contextPath}/" class="btn-main">
            🏠 메인 화면으로
        </a>
        <a href="${pageContext.request.contextPath}/delivery/user/history?u_no=${delivery.u_no}" class="btn-history">
            📋 나의 배달 주문 내역
        </a>
    </div>
</div>
